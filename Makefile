...
LINKER_SCRIPT = 'mcu/startup/stm32f030r8_main.ld'

INCLUDES += -Imcu/std_lib/stm32f0xx/inc
INCLUDES += -Imcu/std_lib/stm32f0xx/src

VPATH += mcu/std_lib/stm32f0xx/inc
VPATH += mcu/std_lib/stm32f0xx/src
...
all: clean
	@make MCU=STM32F030R8 -s -j job_main
